...
let
  pname = "t3code";
  version = "0.0.30";
  linuxHash = "sha256-CQNJUh4hR24zDxcFLF1GwloPP1ZKP3ZiN/V/JJe8DYs=";
  darwinX64Hash = "sha256-POZxmfSb9P9igzOlKESBd6GA+XR5z0gb2by5vjADhCM=";
  darwinArm64Hash = "sha256-MgK3pWD90OO+4AyUxqgJZwrczIiRdLseGRLk2yntz4E=";
